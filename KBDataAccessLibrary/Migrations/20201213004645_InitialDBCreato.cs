...
{
    public partial class InitialDBCreato : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassInstructor", x => new { x.ClassesClassId, x.InstructorsInstructorId });
                    table.ForeignKey(
                        name: "FK_ClassInstructor_Classes_ClassesClassId",
                        column: x => x.ClassesClassId,
                        principalTable: "Classes",
                        principalColumn: "ClassId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClassInstructor_Instructors_InstructorsInstructorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassInstructor_InstructorsInstructorId",
